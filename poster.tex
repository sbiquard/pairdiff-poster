  ...
  \begin{columns}[t]
    ...
    \begin{column}{\colwidth}
      ...
      \begin{alertblock}{The pair differencing approach}
        ...
        This simple approach has been (and still is) used in CMB experiments such as Polarbear or BICEP. % TODO: citations
    ...
    \begin{column}{\colwidth}
      ...
      \begin{block}{Preliminary results}
        ...
        Our current setup uses the TOAST framework for simulating data
