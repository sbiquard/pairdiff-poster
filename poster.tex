  ...
  \begin{columns}[t]
    ...
    \begin{column}{\colwidth}
      ...
      \begin{alertblock}{Quick review of map-making flavors}
        ...
        % TODO: comment about how the different methods deal with those contaminants

      \end{alertblock}

      \begin{block}{The pair differencing approach}

        \begin{wrapfigure}{r}{0.4\colwidth}
        ...
        This simple approach has been (and still is) used in CMB experiments such as Polarbear, BICEP, (others ?) % TODO: citations
        ...
        Strong noise correlations increase $\kappa$. By removing most of the intensity signal of the atmosphere, we also drastically improve the convergence speed of the algorithm (Figure~\ref{fig:convergence}). % TODO: use autoref ?

        % TODO: comment about near optimality of pair diff
    ...
    \begin{column}{\colwidth}
      ...
      \begin{block}{Simulations and results}
        ...
        % The Simons Observatory (SO) is a ground-based CMB experiment located on Cerro Toco, $\qty[mode=text]{5300}{\meter}$ above sea level, in the Atacama desert of Chile.
